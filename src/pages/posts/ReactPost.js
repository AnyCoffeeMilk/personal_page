function Title() {
	return (
		<h2 className="text-4xl pb-20 flex items-center font-bold">
			...
			<span className="text-brand">&lt;</span>ReactJS — 让你爱上模块化编程<span className="text-brand">/&gt;</span>
...
function ReactPost() {
    return (
        <div className="lg:px-[10%] px-8 pb-[10%] mx-auto max-w-[1300px]">
			...
			<section>
				<div>
                    <SubTitle text="ReactJS是什么" />
					<div className="flex space-x-8">
						<Description />
						<div>
							<Image />
							<div className="pt-4 grid grid-cols-[60px_1fr]">
								<span>原作者</span><span className="text-end">Jordan Walke</span>
								<span>编程语言</span><span className="text-end">JavaScript</span>
								<span>开发者</span><span className="text-end">Meta开源及其社区</span>
							</div>
						</div>
					</div>
				</div>
